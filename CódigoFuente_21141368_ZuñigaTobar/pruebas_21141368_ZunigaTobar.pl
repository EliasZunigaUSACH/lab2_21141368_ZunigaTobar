...
flow(1, "Flujo 1 Chatbot3\n ¿Qué te gustaría comprar?", [OP22, OP23, OP24], F40),
chatbot(3, "Agencia de compras", "Bienvenido\n ¿Qué te gustaría comprar?", 1, [F40], CB3),

% CREACIÓN DEL NUEVO CHATBOT4
...
flow(1, "Flujo 1 Chatbot4\n ¿Qué te gustaría cocinar?", [OP25, OP26, OP27], F50),
chatbot(4, "Cocinero", "Bienvenido\n ¿Qué te gustaría cocinar?", 1, [F50], CB4),

% CREACIÓN DEL NUEVO CHATBOT5
option(1, "1) Libros", 5, 1, ["libro", "libros"], OP28),
option(2, "2) Página", 5, 1, ["web", "internet"], OP29),
option(3, "3) Volver", 0, 1, ["volver", "salir", "regresar"], OP30),
flow(1, "Flujo 1 Chatbot5\n ¿Qué te gustaría leer?", [OP28, OP29, OP30], F60),
chatbot(5, "Bibliotecario", "Bienvenido\n ¿Qué te gustaría leer", 1, [F60], CB5),

% Segundo flujo para Chatbot3
